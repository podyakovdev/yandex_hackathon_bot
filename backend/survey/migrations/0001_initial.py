# Generated by Django 3.2.3 on 2025-09-29 21:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('closed', 'Closed'), ('open', 'Open'), ('suggest', 'Suggest')], help_text='Тип вопроса', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(help_text='Текст варианта ответа', max_length=255)),
